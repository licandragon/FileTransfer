  ...
  <Transition name="panel">
    <div v-if="show"
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <button @click="$emit('update:show', false)" class="text-gray-400 hover:text-black dark:hover:text-white transition-colors">✕</button>
      </div>
      ...
      <div class="space-y-6 overflow-y-auto custom-scrollbar pr-2 flex-1">
        ...
        <div class="space-y-3">
          ...
          <div class="flex bg-gray-100 dark:bg-[#1a1a1d] p-1 rounded-2xl">
            <button @click="$emit('update:mode', 'email')"
            ...
            <button @click="$emit('update:mode', 'link')"
        ...
        <div class="space-y-4">
          ...
          <input v-if="extraOptions.hasPassword" 
                 type="password" 
...
defineProps(['show', 'mode']);
defineEmits(['update:mode', 'update:show']);
