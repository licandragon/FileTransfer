  ...
  <div class="login-page">
    ...
    <div class="login-card">
      ...
      <div class="text-center mb-7">
        ...
        <h1 class="text-[1.6rem] font-bold tracking-[-0.03em]
      ...
      <form class="flex flex-col gap-4" @submit.prevent="handleLogin" novalidate>
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <label for="email" class="text-[0.82rem] font-semibold text-[#9a938c]
          ...
          <div class="field-input-wrap">
            ...
            <input id="email" v-model.trim="form.email" type="email" class="field-input"
              placeholder="usuario@ejemplo.com" autocomplete="email" @blur="validateEmail" />
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <label for="password" class="text-[0.82rem] font-semibold text-[#9a938c]
            uppercase tracking-[0.04em]">
            Contraseña
          </label>
          ...
          <div class="field-input-wrap">
            ...
            <input id="password" v-model="form.password" :type="showPassword ? 'text' : 'password'" class="field-input"
              placeholder="••••••••" autocomplete="current-password" @blur="validatePassword" />
