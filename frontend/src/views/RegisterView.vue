...
<template>
    <div class="flex items-center justify-center min-h-[calc(100vh-65px)] px-4 py-8">
        <div
            class="w-full max-w-md bg-[rgba(22,22,26,0.85)] border border-[rgba(255,255,255,0.06)] rounded-2xl p-7 backdrop-blur animate-fade">
            <!-- HEADER -->
            <div class="text-center mb-6">
                ...
                <p class="text-[#6b6560] text-sm mt-1">Regístrate para comenzar</p>
            </div>
            ...
            <form class="flex flex-col gap-4" @submit.prevent="handleRegister">
                ...
                <div class="flex flex-col gap-1">
                    <label class="text-[0.8rem] text-[#9a938c]"> Nombre </label>
                ...
                <!-- EMAIL -->
                <div class="flex flex-col gap-1">
                    <label class="text-[0.8rem] text-[#9a938c]"> Email </label>
                ...
                <div class="flex flex-col gap-2">
                    <label class="text-[0.8rem] text-[#9a938c]"> Contraseña </label>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" @click="showPassword = !showPassword"
                            class="absolute right-3 top-1/2 -translate-y-1/2 text-[#6b6560] hover:text-[#c8a96e] transition">
                            {{ showPassword ? "🙈" : "👁️" }}
                        </button>
                    </div>
                ...
                <!-- CONFIRM PASSWORD -->
                <div class="flex flex-col gap-1">
                    <label class="text-[0.8rem] text-[#9a938c]"> Confirmar contraseña </label>
                ...
                <!-- SUBMIT -->
                <button :disabled="!formValid || isLoading" type="submit"
                    class="mt-2 py-[0.65rem] rounded-lg font-semibold text-[0.9rem] transition bg-linear-to-br from-[#c8a96e] to-[#a0834e] text-[#0d0d0f] hover:opacity-90 disabled:opacity-40">
                    Crear cuenta
                </button>
            </form>
