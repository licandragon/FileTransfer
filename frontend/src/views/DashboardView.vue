...
<template>
  <div class="dashboard flex flex-col gap-7">
    ...
    <section class="grid gap-4
      ...
      <div v-for="(stat, i) in stats" :key="stat.label" class="stat-card flex items-center gap-4
        p-5 rounded-xl
        bg-[rgba(22,22,26,0.8)]
        border border-[rgba(255,255,255,0.06)]" :style="{ animationDelay: `${i * 0.08}s` }">
        ...
        <div class="text-[0.78rem] font-semibold px-2 py-0.5 rounded-md"
    ...
    <div class="grid gap-4 lg:grid-cols-[1fr_340px]">
      ...
      <section class="panel">
        ...
        <ul class="flex flex-col gap-3">
          <li v-for="(item, i) in activity" :key="i" class="activity-item" :style="{ animationDelay: `${i * 0.07}s` }">
      ...
      <section class="panel">
        ...
        <button class="w-full py-[0.7rem] rounded-lg
          text-[#e07070] font-semibold text-[0.9rem]
          bg-[rgba(224,112,112,0.08)]
          border border-[rgba(224,112,112,0.25)]
          transition hover:bg-[rgba(224,112,112,0.15)]" @click="handleLogout">
          Cerrar sesión
        </button>
      </section>
...
.dot--success {
  background: #6fcf97;
  box-shadow: 0 0 6px #6fcf9788;
}

.dot--info {
  background: #6eb4e8;
  box-shadow: 0 0 6px #6eb4e888;
}

.dot--warning {
  background: #e8c46e;
  box-shadow: 0 0 6px #e8c46e88;
}
